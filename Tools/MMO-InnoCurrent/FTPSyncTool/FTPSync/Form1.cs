...
namespace ABSoft.Photobookmart.FTPSync
{
    public partial class Form1 : Form
    {
        ...
        {
            TabControl_DeleteItem(tcInnoCurrent.TabCount - 1);
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            UpdateButtonState();*/
            #endregion
            InitializeBrowserEvents(wbextInnoCurrent);

            string url_current = @"";
            string url_start_earning = @"https://www.innocurrent.com/start_earning.php";

            wbextInnoCurrent.ScriptErrorsSuppressed = true;
            wbextInnoCurrent.Navigate(new Uri(url_start_earning));
            while (wbextInnoCurrent.ReadyState != WebBrowserReadyState.Complete)
            {
                System.Threading.Thread.Sleep(1 * 1000);
                Application.DoEvents();
            }
            url_current = wbextInnoCurrent.Url.ToString();
            txtFTPHost.Text = url_current;
        }
